...
export KNATIVE_EVENTING_VERSION="0.19.3"
...
# Kafka channel CRD config template directory.
readonly KAFKA_SOURCE_CRD_YAML="https://github.com/knative-sandbox/eventing-kafka/releases/download/v0.19.2/source.yaml"
