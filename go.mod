...
require (
	...
	knative.dev/client/pkg v0.0.0-20260422023613-252b86910700
	knative.dev/eventing-kafka-broker v0.48.1-0.20260422213414-0744100b7b9e
...
require (
	...
	knative.dev/serving v0.48.1-0.20260421173012-bbc132d832f2 // indirect
