...
require (
	...
	knative.dev/eventing-kafka v0.36.1-0.20230419162738-5ea5ea0e3ead
...
require (
	...
	knative.dev/eventing v0.36.1-0.20230418180955-193f2dffd536 // indirect
	knative.dev/networking v0.0.0-20230412014752-750a9e4f13f1 // indirect
	knative.dev/serving v0.36.1-0.20230418170156-b38ef3a7ff2c // indirect
